...
In this case the problems with the annotation may be due to the versions as our snapshot was made 27-04-2020 which is the same date as version 101 (we used version 102 for counting reads in Day 1) was released. It is good to keep an eye on these things so you don't miss releases.
